...
//      }
         ...
         if (text == "a1" || text == "A1") {
          digitalWrite(R1, HIGH);
          digitalWrite(R2, LOW);
          bot.sendMessage(chat_id, from_name + " / Arcondicionado 1 Ligado / Arcondicionado 2 Desligado", "");
        }
        ...
        if (text == "a2" || text == "A2") {
          ...
          bot.sendMessage(chat_id, from_name + " / Arcondicionado 2 Ligado / Arcondicionado 1 Desligado", "");
        }
